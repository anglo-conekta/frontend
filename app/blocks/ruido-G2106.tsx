...
import PdfRuido06 from "@/components/ui/pdfRuido06";
...
const chartData = [
  ...
  { month: "Semestre 1", npsmax: 52,},
  { month: "Semestre 2", npsmax: 48,},
   { month: "Semestre 3", npsmax: 42,},
]
...
const chartConfig = {
  ...
  <div className="w-full py-6">
    <div className="container mx-auto">
        <div className="py-6">
                <h2>Registro Base punto G21-06</h2>
</div>
      ...
      <TabsContent value="foto">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
             Registro Base punto G21-06
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-2">
            <PdfRuido06></PdfRuido06>
