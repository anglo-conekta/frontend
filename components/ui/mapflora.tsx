...
const MapFlora: React.FC = () => {
  ...
  const kmlLayers: KmlLayer[] = [
    { name: "Zonales", url: "https://aymarasamudio.com/PlantasZonales.kmz" },
    { name: "Azonales", url: "https://aymarasamudio.com/PlantasAzonales.kmz" },
