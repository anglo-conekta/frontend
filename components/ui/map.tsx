...
const Map3: React.FC = () => {
  ...
  const kmlLayers: KmlLayer[] = [
    { name: "Glaciares", url: "https://aymarasamudio.com/glaciares.kmz" },
    { name: "Aire", url: "https://aymarasamudio.com/aire.kmz" },
    { name: "Agua", url: "https://aymarasamudio.com/HidroGeologia.kmz" },
    { name: "Ruido", url: "https://aymarasamudio.com/Ruido-ultimo.kmz" },
    ...
    { name: "Animales Silvestres", url: "https://aymarasamudio.com/EsfuerzoMuestreo.kmz" },
    { name: "Suelo", url: "https://aymarasamudio.com/influenciasuelo.kml" }, 
    { name: "Arqueología", url: "https://aymarasamudio.com/arqueologia2.kmz" },   
    { name: "Vialidad", url: "https://aymarasamudio.com/Vialidad.kmz" },   
  ];
