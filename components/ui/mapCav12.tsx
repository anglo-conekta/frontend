...
const MapCav12: React.FC = () => {
  ...
  const kmlLayers: KmlLayer[] = [
    { name: "Trampas Sherman", url: "https://aymarasamudio.com/TrampasSherman.kmz" },
    { name: "Transectos", url: "https://aymarasamudio.com/Transectos.kmz" },
    { name: "Esfuerzo Muestreo", url: "https://aymarasamudio.com/EsfuerzoMuestreo.kmz" },
  ];
